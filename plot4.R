plotGraph4 <- function(){
     ...
     par(mfrow = c(2,2))
     # Global Active Power    
     plot(weekDays, hpc$Global_active_power, type= "l", ylab='Global Active Power', xlab="")
     
     # Voltage
     plot(weekDays, hpc$Voltage, type="l", xlab="datetime", ylab="Voltage")
     ...
     legend("topright", c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), lty=c(1,1), lwd=c(2.5,2.5,2.5),col=c("black", "red","blue"), box.lty=0)
     
     plot(weekDays, hpc$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
